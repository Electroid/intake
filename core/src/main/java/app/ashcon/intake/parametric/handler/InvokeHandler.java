...
/**
 * An invoke handler can be registered on a {@link ParametricBuilder} to listen in on commands being
 * executed.
 *
 * <p>Invoke handlers have access to three different stages of command execution and can view the
 * annotations, parameters, and arguments of the command. An invoke handler could be used to
 * implement command logging, for bukkit.
 */
public interface InvokeHandler {
   ...
   */
  boolean preProcess(
      List<? extends Annotation> annotations, ArgumentParser parser, CommandArgs commandArgs)
