...
import app.ashcon.intake.completion.NullCompleter;
...
public class ParametricBuilder {
   ...
   *
   * <p>Invocation handlers are called in order that their listeners are registered with a
   * ParametricBuilder. It is not guaranteed that a listener may be called, in the case of a {@link
   * CommandException} being thrown at any time before the appropriate listener or handler is
   * called.
   *
  ...
  /**
   * Attach an exception converter to this builder in order to wrap unknown {@link Throwable}s into
   * known {@link CommandException}s.
   *
   * <p>Exception converters are called in order that they are registered.
   *
   ...
   *
   * <p>Bindings will still be resolved in the thread in which the callable was called.
   *
   ...
   *
   * <p>Bindings will still be resolved in the thread in which the callable was called. a
   *
  ...
  /**
   * Build a list of commands from methods specially annotated with {@link Command} (and other
   * relevant annotations) and register them all with the given {@link Dispatcher}.
   *
   ...
   */
  public void registerMethodAsCommand(Dispatcher dispatcher, Method method)
   ...
   * @throws ParametricException thrown if the commands cannot be registered
   */
  public void registerMethodAsCommand(Dispatcher dispatcher, Object object, Method method)
      throws ParametricException {
