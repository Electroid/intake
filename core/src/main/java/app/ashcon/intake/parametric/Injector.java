 ...
 *
 * <p>For bukkit, a command might accept an integer as an argument, and so an appropriate binding
 * for that parameter would have a provider that parsed the argument as an integer and returned it.
 */
