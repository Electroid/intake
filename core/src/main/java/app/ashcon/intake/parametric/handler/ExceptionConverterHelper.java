...
/**
 * An implementation of an {@link ExceptionConverter} that calls methods defined in subclasses that
 * have been annotated with {@link ExceptionMatch}.
 *
 * <p>Only public methods will be used. Methods will be called in order of decreasing levels of
 * inheritance (between classes where one inherits the other). For two different inheritance
 * branches, the order between them is undefined.
 */
