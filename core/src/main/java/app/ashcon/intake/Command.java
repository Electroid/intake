...
public @interface Command {
  ...
  /**
   * A list of aliases for the command. The first alias is the name of the command and considered
   * the main alias.
   *
   ...
   *
   * <p>An bukkit would be {@code [-h &lt;value&gt;] &lt;name&gt; &lt;message&gt;}.
   *
   * <p>If a parametric command is used, this field is unnecessary because usage information will be
  ...
  /**
   * Flags allow special processing for flags such as -h in the command, allowing users to easily
   * turn on a flag. This is a string with each character being a flag. Use A-Z and a-z as possible
   * flags. Appending a flag with a : makes the flag character before a value flag, meaning that if
   * it is given, it must have a value.
   *
   ...
   *
   * <p>The value of this property overrides {@link #flags()}.
   *
