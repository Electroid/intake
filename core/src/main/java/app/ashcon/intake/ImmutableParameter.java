...
public final class ImmutableParameter implements Parameter {
  ...
  @Nullable private final OptionType optionType;
  private final List<String> defaultValue;
  private final boolean isOptional;

  private ImmutableParameter(
      String name, OptionType optionType, List<String> defaultValue, boolean isOptional) {
    this.name = name;
   ...
   *
   * <p>By default, the default value will be an empty list.
   */
  public static class Builder {
     ...
     *
     * <p>An empty list implies that there is no default value.
     *
     ...
     * Create an instance.
     *
     * <p>Neither {@code name} nor {@code optionType} can be null.
     *
     * @return The instance
     */
