...
public class DispatcherNode extends AbstractDispatcherNode {
  ...
  /**
   * Build and register all commands within a class with this dispatcher using the {@link
   * ParametricBuilder} assigned on the root {@link CommandGraph}.
   *
   ...
   *
   * <p>The object returned by this method can be used to add sub-commands. To return to this
   * "getParent" context, use {@link DispatcherNode#graph}.
   *
