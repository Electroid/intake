...
public interface Dispatcher extends CommandCallable {
  ...
  /**
   * Get a list of commands. Each command, regardless of how many aliases it may have, will only
   * appear once in the returned set.
   *
   * <p>The returned collection cannot be modified.
   *
   ...
   *
   * <p>A command may have more than one alias assigned to it. The returned collection cannot be
   * modified.
   *
   * @return a list of aliases
   */
